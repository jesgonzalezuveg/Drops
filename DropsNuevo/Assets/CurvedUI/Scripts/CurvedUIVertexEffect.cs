...
public partial class CurvedUIVertexEffect : BaseVertexEffect {
    ...
    public override void ModifyMesh (Mesh mesh) {
        ...
        UIVertex TesselateQuad(UIVertex[] quad, float x, float y) {
            ...
            UIVertex cosaFeaEsta = new UIVertex();
            ...
            //4. return output
            cosaFeaEsta.position = pos;
            //ret.color = Color32.Lerp(Color32.Lerp(quad[3].color, quad[1].color, y), Color32.Lerp(quad[0].color, quad[2].color, y), x);
            cosaFeaEsta.color = quad[0].color; //used instead to save performance. Color lerps are expensive.
            cosaFeaEsta.uv0 = uv0;
            cosaFeaEsta.uv1 = uv1;
            cosaFeaEsta.normal = quad[0].normal;
            cosaFeaEsta.tangent = quad[0].tangent;
